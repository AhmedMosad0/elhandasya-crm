...
ordersRouter.patch('/:id/status', requireRole('admin', 'mixer', 'delivery'), ordersController.updateStatus);
ordersRouter.post('/:id/payments', requireRole('admin'), ordersController.addPayment);
