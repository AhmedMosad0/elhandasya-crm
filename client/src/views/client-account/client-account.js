...
export function renderClientAccount() {
  const c = getClients().find(x => x.id === App.user.clientId) || null;
  const myOrds = getOrders().filter(o => o.clientId === App.user.clientId).sort((a, b) => b.createdAt.localeCompare(a.createdAt));
