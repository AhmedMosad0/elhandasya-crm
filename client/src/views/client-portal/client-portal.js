...
export async function renderClientPortal() {
  document.getElementById('sectionClientportal').innerHTML = '<div class="empty" style="padding:40px">Loading…</div>';
  try {
    // Server already filters orders to this client via JWT role check
    ...
    document.getElementById('sectionClientportal').innerHTML = '<div class="empty" style="padding:40px">Failed to load portal</div>';
